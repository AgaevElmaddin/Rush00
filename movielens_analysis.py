...
if __name__ == '__main__':
	...
	#print(Movies('ml-latest-small/movies.csv').most_genres(2))
	#print(Ratings('ml-latest-small/ratings.csv', 'ml-latest-small/movies.csv').movies.top_by_num_of_ratings(2))
